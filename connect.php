...
if (isset($_POST['reg_user'])) {
  ...
  $user_check_query = "SELECT * FROM puser WHERE username='$username' OR email='$email' LIMIT 1";
  ...
  if (count($errors) == 0) {
  	...
  	$query = "INSERT INTO puser (username, email, password) 
...
if (isset($_POST['login_user'])) {
  ...
  if (count($errors) == 0) {
  	...
  	$query = "SELECT * FROM puser WHERE username='$username' AND password='$password'";
